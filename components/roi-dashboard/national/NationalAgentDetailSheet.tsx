...
import { useNational, formatNatMetric } from "@/lib/roi-dashboard/national/store";
import { Sparkline } from "@/components/roi-dashboard/facility19/Sparkline";

export function NationalAgentDetailSheet() {
  const { agents, selectedAgent, setSelectedAgent, events } = useNational();
        ...
        {agent && (
          <>
            ...
            <div className="mt-5 rounded-xl border border-border p-4">
              ...
              <div className="mt-1 font-display text-3xl font-bold tracking-tight">{formatNatMetric(agent.metricValue, agent.metricFormat)}</div>
