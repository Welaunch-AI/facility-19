import { Activity, Wind, Zap, Droplets, Sparkles } from "lucide-react";
import { type Agent, formatMetric, useFacility19 } from "@/lib/roi-dashboard/facility19/store";
...
export function AgentCard({ agent }: { agent: Agent }) {
  ...
  const { setSelectedAgent } = useFacility19();
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex items-baseline gap-2">
              <span className="font-display text-2xl font-bold tracking-tight">
                <AnimatedNumber value={agent.metricValue} format={(n) => formatMetric(n, agent.metricFormat)} />
              </span>
