...
import { useField, formatFieldMetric } from "@/lib/roi-dashboard/field/store";
import { Sparkline } from "@/components/roi-dashboard/facility19/Sparkline";

export function FieldAgentDetailSheet() {
  const { agents, selectedAgent, setSelectedAgent, events } = useField();
        ...
        {agent && (
          <>
            ...
            <div className="mt-5 rounded-xl border border-border p-4">
              ...
              <div className="mt-1 font-display text-3xl font-bold tracking-tight">{formatFieldMetric(agent.metricValue, agent.metricFormat)}</div>
